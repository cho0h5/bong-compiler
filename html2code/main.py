...
label = (
    "dummy"
    ,"Int","Void","Lbracket","IntLit","Rbracket","Pointer","Lbrace","Rbrace","Semicolon","Identifier"
    ,"Lparen","Rparen","Comma","StringLit","LogOp","RelOp","AddOp","MulOp","UnaryOp","AssignOp"
    ,"If","While","Return","Break","Continue"
    ,"EOL"
    ,"PROGRAM_","PROGRAM","TYPE","ARRAY_TYPE","POINTER_TYPE","BLOCK","STATEMENT_LIST","VAR_DECL","FUNCTION_DECUL","PARAMETERS"
